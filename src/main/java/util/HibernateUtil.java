	...
	static {
		try {
			...
			config.addAnnotatedClass(Cliente.class);
    	 	...
    	 	config.addAnnotatedClass(ItemOrdenPedidoId.class);
    	 	config.addAnnotatedClass(ItemRemito.class);
    	 	config.addAnnotatedClass(ItemRemitoId.class);
    	 	config.addAnnotatedClass(ItemsComparativaPrecio.class);
    	 	config.addAnnotatedClass(ItemsListaPrecios.class);
    	 	...
    	 	config.addAnnotatedClass(RemitoInterior.class);
